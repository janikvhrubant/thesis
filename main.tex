...
\thesistitle{Quasi-Monte Carlo Methods \\ and Neural Networks} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
% Funded by SAP, this research project is aimed at providing informed recommendations to the development team to enhance production code, ultimately leading to the creation of the Predictive Replenishment Planning (PRP) tool, a feature within the S4/HANA Cloud offering.\end{abstract}

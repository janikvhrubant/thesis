...
{\cite[Satz~1.2]{pillichshammer2010zahlentheoretische}}] \ \\
\textcolor{green}{\textbf{TODO: Satz oder Theorem?}} \\
...
particularly suitable for adaptive algorithms, especially for anytime algorithms
that might increment the number of samples needed over time. However, not all

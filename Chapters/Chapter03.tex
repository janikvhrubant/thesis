...
\begin{definition}[Ladder] \ \\
    ...
    The ladder could consist of different number of points in each dimension.

    The \emph{successor} of a point $y \in \mathcal{Y}$ in the ladder is defined
    componentwise as
    \begin{equation*}
        y_+^j = \min \bigg\{ (y^j, b_j] \cup \big( \mathcal{Y}^j \cap \{b_j\} \big) \bigg\}
    \end{equation*}
...
\begin{remark}
    ...
    Further $\mathbb{Y}$ denotes the set of all such ladders on $[a,b]$.
\end{remark}
\qquad

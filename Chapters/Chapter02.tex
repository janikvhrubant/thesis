...
\cite[Section~2.3]{leobacher2014introduction}.
...
Throughout this thesis, the terms low-discrepancy sequence and \ac{qmc} sequence
are used interchangeably, as is common in literature.
...
Therefore functions from the \emph{ring of polynomials} $\mathbb{F}_2[x] = \{
a_0 + a_1 x + a_2 x^2 + \dots + a_n x^n \mid n \in \mathbb{N},\; a_i \in
\mathbb{F}_2 \}$ with coefficients in the finite field $\mathbb{F}_2$ are
necessary.
...
available in the Python package \texttt{SciPy} (version~1.16.0) through the
module \texttt{scipy.stats.qmc} \cite{virtanen2020scipy, scipy-qmc} were used.
The sobol and halton sequences from this package though follow

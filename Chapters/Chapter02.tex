...
\end{equation*}
Hereby $A([\boldsymbol{a},\boldsymbol{b}), \mathcal{P})$ denotes the number of
...
% ------------------------------------------------------------------------------
Now we will introduce the concept of low-discrepancy sequences and analyse their
...
1954 that for everz dimension $s \in \mathbb{N}$ there exists a constant $c_s >
...
representation about the decimal point. This function is defined as follows:
...
John Halton generalized this idea to higher dimensions by combining multiple Van
der Corput sequences in different bases in 1960 \cite{halton1960efficiency}.
...
\texttt{scipy.stats.qmc} \cite{virtanen2020scipy, scipy-qmc} were used. The
Sobol' and Halton sequences from this package though follow

...
Let $\mathcal{P}\subset [0,1)^s$ with $|\mathcal{P}| = N$ be a finite point
...
\end{equation*}
Hereby $A([\boldsymbol{a},\boldsymbol{b}), \mathcal{P})$ denotes the number
...
Throughout this thesis, the terms low-discrepancy sequence and \ac{qmc} sequence are used interchangeably, as is common in literature.

...
Hounsfield units, which encode tissue-specific attenuation properties and serve
as the basis for accurate dose calculation in radiation therapy
...
Hounsfield units provide a dimensionless measure of X-ray attenuation. They are
defined by normalizing the reconstructed attenuation coefficient~$\mu$ with
respect to water and air:
\begin{equation}
